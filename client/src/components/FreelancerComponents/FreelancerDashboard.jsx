            ...
            {data?.dashboard ? (
              <>
                ...
                <div className="stats">
                  <div className="card">
                    <div className="info">
                      <div className="title">Total Revenues</div>
                      <div className="body-stat">
                        {data?.dashboard?.revenues} ₹
                      </div>
                    </div>
                    <div className="logo">
                      <img src={usd} alt="Money icon" />
                    </div>
                  </div>
                  <div className="card">
                    <div className="info">
                ...
                <div className="testimonials">
                  <div className="header">Last Reviews</div>
                  <div className="cards">
              ...
              <div className="serverStopped">Run the server</div>
            )}
          </div>
          <FreelancerMenu active="dashboard" />
        </div>
      </div>
    </>
  );
