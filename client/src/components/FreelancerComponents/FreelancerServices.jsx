        ...
        <div className="container">
          <div className="section">
            <div className="service-management-header">
              ...
              <p>Create new services or manage your existing ones</p>
            </div>
            <div className="buttons service-management-buttons">
              <HashLink to={`/dashboard/freelancer/${id}/services/create`}>
                <button className="create-service-btn">
                  <i className="plus-icon">+</i> Create New Service
                </button>
              </HashLink>
              <HashLink to={`/dashboard/freelancer/${id}/services/manage`}>
                <button className="manage-service-btn">
                  <i className="manage-icon">⚙️</i> Manage Existing Services
                </button>
              </HashLink>
            </div>
            <div className="services">
              {data?.allServices && data.allServices.length > 0 ? (
                ...
                <div className="noServices">No Services Available</div>
              )}
            </div>
          </div>
