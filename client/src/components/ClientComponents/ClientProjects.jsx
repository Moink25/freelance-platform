...
export default function ClientProjects() {
  ...
  useEffect(() => {
    console.log("ClientProjects component mounted");
  ...
  useEffect(() => {
    console.log("Current client projects state:", clientProjects);
    if (error) {
  ...
  const loadProjects = () => {
    ...
    dispatch(getClientProjects())
      .unwrap()
      .then((result) => {
        console.log("Client projects loaded:", result);
        setTimeout(() => {
          setLoading(false);
        }, 500);
      })
