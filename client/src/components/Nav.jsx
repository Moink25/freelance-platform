            ...
            {loggedUser == null ? (
              ...
              <div className="menu">
                ...
                <img
                  ...
                  onClick={(e) => dropdown.current.classList.toggle("active")}
                  alt="Profile Picture"
                />
                <div ref={dropdown} className="dropdown">
                  <div className="link" onClick={(e) => handleProfile()}>
                    Dashboard
                  </div>
                  <div className="link" onClick={(e) => handleLogOut()}>
                    Log Out
                  </div>
                </div>
              </div>
